...
describe('App', () => {
  it('presents the project purpose and local boundary delivery model', () => {
    ...
    expect(wrapper.text()).toContain('12 clickable polygons')
    expect(wrapper.text()).toContain('60 clickable polygons')
    expect(wrapper.text()).toContain('visitors do not query Overpass')
